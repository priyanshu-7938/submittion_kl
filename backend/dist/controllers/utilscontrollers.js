...
const hydrateCustomController = async (req, res) => {
    try {
        const insertionString = req.body.insertString;
        if (insertionString) {
...
const hydrateController = async (req, res) => {
    try {
...
export { hydrateController, hydrateCustomController, };
