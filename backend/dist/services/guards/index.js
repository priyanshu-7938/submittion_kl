...
class Guards {
    ...
    // validate fxn
    async validate(message, userId, sessionMessageCount) {
        try {
            // 1. Basic validation
            ...
            if (!unethicalCheck.isValid)
                return unethicalCheck;
    ...
    async validateWithNext(message, userId, next, sessionMessageCount) {
    ...
    checkSessionLimit(messageCount) {
    ...
    //detection methofds...
    detectUnethicalContent(message) {
